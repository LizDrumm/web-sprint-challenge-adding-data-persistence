...
1. Explain the difference between `Relational Databases` and `SQL`.
 ...
 A relational db is a place where data is stored and can be easily managed. SQL is a database management system that can manipulate the data found in a database. 

2. Why do tables need a `primary key`?

Requiring a primary key prevents duplication and anomalies.
...
A junction table in order to join the two tables that relate.
